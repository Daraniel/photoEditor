...
public class ModalFrameUtil{
    ...
    public static void showAsModal(final Frame frame, final Frame owner){
        ...
        try {
            JPanel jPanel = (JPanel) ((JFrame) frame).getContentPane().getComponent(0);
            if (jPanel.getComponentCount() == 4 && jPanel.getComponent(0) instanceof JTabbedPane && jPanel.getComponent(3) instanceof JPanel) {
